...
int main()
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	sleep(10);
  11:	6a 0a                	push   $0xa
  13:	e8 ca 03 00 00       	call   3e2 <sleep>
  int pid = fork();
  18:	e8 2d 03 00 00       	call   34a <fork>
  if(pid == 0)
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	ba 23 00 00 00       	mov    $0x23,%edx
  27:	74 37                	je     60 <main+0x60>
...
void ff(int f)
{
  ...
  33:	52                   	push   %edx
  34:	e8 a7 00 00 00       	call   e0 <ff>
  39:	83 ea 02             	sub    $0x2,%edx
...
{
  if(f<1)
  3f:	83 fa ff             	cmp    $0xffffffff,%edx
  ...
  4e:	e8 6d 04 00 00       	call   4c0 <printf>
    wait();
  53:	e8 02 03 00 00       	call   35a <wait>
  58:	83 c4 10             	add    $0x10,%esp
   // #endif  
  }
  exit();
  5b:	e8 f2 02 00 00       	call   352 <exit>
{
	sleep(10);
  int pid = fork();
  if(pid == 0)
  ...
  63:	6a 0a                	push   $0xa
  65:	e8 78 03 00 00       	call   3e2 <sleep>
    int ppid = fork();
  ...
  76:	ba 20 00 00 00       	mov    $0x20,%edx
  7b:	90                   	nop
...
void ff(int f)
{
  ...
  83:	52                   	push   %edx
  84:	e8 57 00 00 00       	call   e0 <ff>
  89:	83 ea 02             	sub    $0x2,%edx
...
{
  if(f<1)
  8f:	83 fa fe             	cmp    $0xfffffffe,%edx
  ...
  94:	52                   	push   %edx
  95:	52                   	push   %edx
  96:	68 e0 07 00 00       	push   $0x7e0
  9b:	6a 01                	push   $0x1
  9d:	e8 1e 04 00 00       	call   4c0 <printf>
  a2:	83 c4 10             	add    $0x10,%esp
  a5:	eb b4                	jmp    5b <main+0x5b>
  a7:	ba 26 00 00 00       	mov    $0x26,%edx
...
void ff(int f)
{
  ...
  b3:	52                   	push   %edx
  b4:	e8 27 00 00 00       	call   e0 <ff>
  b9:	83 ea 02             	sub    $0x2,%edx
...
{
  if(f<1)
  bf:	83 fa fe             	cmp    $0xfffffffe,%edx
  ...
  c4:	50                   	push   %eax
  c5:	50                   	push   %eax
  c6:	68 e4 07 00 00       	push   $0x7e4
  cb:	6a 01                	push   $0x1
  cd:	e8 ee 03 00 00       	call   4c0 <printf>
      wait();
  d2:	e8 83 02 00 00       	call   35a <wait>
  d7:	83 c4 10             	add    $0x10,%esp
  da:	e9 7c ff ff ff       	jmp    5b <main+0x5b>
  df:	90                   	nop
...
void ff(int f)
{
  ...
  if(f<1)
  ea:	85 db                	test   %ebx,%ebx
  ec:	7e 18                	jle    106 <ff+0x26>
  ee:	66 90                	xchg   %ax,%ax
  return;
  ff(f-1);
...
{
  if(f<1)
 102:	85 db                	test   %ebx,%ebx
 104:	7f ea                	jg     f0 <ff+0x10>
  return;
  ff(f-1);
  ff(f-2);
  return;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 ec 07 00 00       	mov    $0x7ec,%eax
...
free(void *ap)
{
 ...
 661:	a1 b0 0a 00 00       	mov    0xab0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6b9:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 b0 0a 00 00       	mov    %eax,0xab0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 79f:	89 15 b0 0a 00 00    	mov    %edx,0xab0
      return (void*)(p + 1);
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 7bd:	0a 00 00 
 7c0:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	b8 b4 0a 00 00       	mov    $0xab4,%eax
 7cf:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 7d6:	00 00 00 
