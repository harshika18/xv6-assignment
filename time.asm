  ...
  3b:	83 c4 10             	add    $0x10,%esp
{
  ...
  4a:	68 60 07 00 00       	push   $0x760
  4f:	6a 01                	push   $0x1
  51:	e8 da 03 00 00       	call   430 <printf>
 	exit();
  56:	83 c4 20             	add    $0x20,%esp
  59:	e8 64 02 00 00       	call   2c2 <exit>
  		exec(argv[1], argv);
    	printf(1, "exec %s failed\n", argv[1]);
    }
  	else
  ...
  5e:	50                   	push   %eax
  5f:	50                   	push   %eax
  60:	8d 45 f4             	lea    -0xc(%ebp),%eax
  63:	50                   	push   %eax
  64:	8d 45 f0             	lea    -0x10(%ebp),%eax
  67:	50                   	push   %eax
  68:	e8 f5 02 00 00       	call   362 <waitx>
  6d:	83 c4 10             	add    $0x10,%esp
  70:	eb ce                	jmp    40 <main+0x40>
  72:	66 90                	xchg   %ax,%ax
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 98 07 00 00 	movzbl 0x798(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 90 07 00 00       	mov    $0x790,%eax
...
free(void *ap)
{
 ...
 5d1:	a1 34 0a 00 00       	mov    0xa34,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 34 0a 00 00       	mov    %eax,0xa34
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 34 0a 00 00    	mov    0xa34,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 15 34 0a 00 00    	mov    %edx,0xa34
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 72d:	0a 00 00 
 730:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 38 0a 00 00       	mov    $0xa38,%eax
 73f:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 746:	00 00 00 
