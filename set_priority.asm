...
main(int argc, char *argv[])
{
  ...
  19:	7f 13                	jg     2e <main+0x2e>
    {
        printf(2, "Enter proper number of arguments\n");
  1b:	50                   	push   %eax
  1c:	50                   	push   %eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 ac 07 00 00 	movzbl 0x7ac(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 a5 07 00 00       	mov    $0x7a5,%eax
