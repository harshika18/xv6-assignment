...
int main(int argc, char *argv[])
{
  ...
  1e:	e8 0d 02 00 00       	call   230 <atoi>
  ...
  37:	6a 00                	push   $0x0
  39:	53                   	push   %ebx
  3a:	e8 1b 03 00 00       	call   35a <getpinfo>
    exit();
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 4d 07 00 00       	mov    $0x74d,%eax
