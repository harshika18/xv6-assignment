  ...
  3f:	e8 ee 02 00 00       	call   332 <exit>
{
  ...
  65:	d9 05 d8 07 00 00    	flds   0x7d8
  ...
  93:	d9 05 d8 07 00 00    	flds   0x7d8
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 e4 07 00 00 	movzbl 0x7e4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 dc 07 00 00       	mov    $0x7dc,%eax
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 84 0a 00 00       	mov    %eax,0xa84
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 84 0a 00 00    	mov    %edx,0xa84
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 84 0a 00 00 88 	movl   $0xa88,0xa84
 79d:	0a 00 00 
 7a0:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	b8 88 0a 00 00       	mov    $0xa88,%eax
 7af:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 7b6:	00 00 00 
